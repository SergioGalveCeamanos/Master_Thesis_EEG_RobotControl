...
%                 database_1t{j}{i}{n_1}=normalize(piece,1);
    ...
    Y_label= {'C3: 6-9 Hz';'C3: 15-18 Hz';'C3: 9-12 Hz';'C3: 27-30 Hz';'C3: 18-21 Hz';'C3: 30-33 Hz';'Cz: 6-9 Hz';'Cz: 12-15 Hz';'Cz: 27-30 Hz';'Cz: 30-33 Hz';'Cz: 24-27 Hz';'Cz: 55-58 Hz';'C4: 6-9 Hz';'C4: 9-12 Hz';'C4: 12-15 Hz';'C4: 27-30 Hz';'C4: 15-18 Hz';'C4: 18-21 Hz'}
